...
import { updateUser } from "../../schemas/user/update";
...
export default function UserModal() {
    ...
    const { user, listUser, userModal, setUserModal, showError, setAlertModal } = useContext(GlobalContext)
    ...
    return (
        ...
        >
            ...
            <div className="update-pass vertical-align gap2 w100">
                <h3 className='label w100'>Atualizar senha</h3>
                <div className="horizontal-align w100 gap1">
                    <div className='input-label'>
            ...
            {errors.newPassword && <span className="span-error">{errors.newPassword?.message}</span>}
            <div className='horizontal-align jc-between w100'>
